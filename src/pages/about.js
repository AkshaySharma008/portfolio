            ...
            <p className="experiencePage-name text-center pt-4">ABOUT ME</p>
                <div className="row">
                    ...
                    <div className="col-md-7 my-2">
                        <p>
	                    Okay, so people call me Akshay. I am an Open-Source geek, Vegetarian, and an Adventure sports addiced. 
                        For that, I would like to explore as much as I can, on mountains, valleys, deserts and my life.
                         My body is made up of HTML, CSS & JavaScript, which literally defines me! 
                        ...
                        I'm a Software Engineer and a highly motivated, passionate hard-core web developer with experience in
                         ...
                         potential to create huge positive impact on the world.<br></br><br></br>
                        I conducts classes, seminars, webinars, and took personal mentoring sessions to help students technolgically & mentally.
                        I love to contribute to community and help others and for that i have been working as a Secretary of <a href="https://www.aitoss.club" >OSS Club</a> , <a href="https://dsc.community.dev/army-institute-of-technology/" >DSC Lead</a> at my Campus.
                        </p>
                    </div>
                </div>
